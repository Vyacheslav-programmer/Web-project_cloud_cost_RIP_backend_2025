...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='TariffForecastcloudprice',
            fields=[
                ('pk', models.CompositePrimaryKey('tariff_id', 'forecastCloudPrice_id', blank=True, editable=False, primary_key=True, serialize=False)),
                ('count', models.IntegerField(default=0)),
                ('forecastCloudPrice', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='app.forecastcloudprice')),
